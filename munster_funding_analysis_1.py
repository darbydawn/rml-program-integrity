"""
Vincent Munster -- NIH Intramural Funding Analysis
...
print("=" * 65)
print("MUNSTER NIH INTRAMURAL FUNDING SUMMARY")
print("=" * 65)
...
print(f"FY2025 (arrest year) total:  ${fy2025_total:,.0f}")

print(f"\n{'='*65}")
print(f"PROGRAM INTEGRITY FINDINGS")
print(f"{'='*65}")
print(f"""
...
FINDING 3: RAPID BUDGET GROWTH
  ...
  FY2025 combined: $3,744,306 -- still funded year of arrest

FINDING 4: THREE ACTIVE PROJECTS AT TIME OF CRIMINAL CHARGES
  All three ZIA projects were funded in FY2025.
  Federal funding continued without interruption through
  the arrest date and criminal charges filing.

FINDING 5: DARPA FUNDING NOT INCLUDED IN THESE TOTALS
  Two DARPA PREEMPT awards in FY2018 are in DOD budget.
  Total federal investment in Munster's research exceeds
...
ax1.axvline(x=2025.5, color='#ffffff', linestyle='--', 
            alpha=0.8, linewidth=1.5, label='Arrest: Jan 2026')
ax1.text(2025.6, max(bottoms)*0.9, 'Arrest\nJan 2026', 
         color='white', fontsize=8, va='top')

ax1.set_xlabel('Fiscal Year', color='white', fontsize=11)
ax1.set_ylabel('$ Millions', color='white', fontsize=11)
ax1.set_title("Munster NIH Intramural Funding\nBy Project | FY2013-2025", 
...
plt.suptitle('Vincent Munster -- Federal Research Funding Analysis\nProgram Integrity Investigation | June 2026',
